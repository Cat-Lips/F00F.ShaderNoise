...
public partial class PerlinNoise : CustomResource
{
    ...
    public ShaderMaterial ShaderMaterial { get; set => this.Set(ref field, value ?? NewShaderMaterial(), OnShaderMaterialSet); } = NewShaderMaterial();
    ...
    private static ShaderMaterial NewShaderMaterial() => new() { Shader = new() };
