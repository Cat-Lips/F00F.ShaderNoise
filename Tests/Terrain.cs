...
namespace F00F.ShaderNoise.Tests
{
    ...
    public partial class Terrain : StaticBody3D
    {
        ...
        [Export] public TerrainData Config { get; set => this.Set(ref field, value, OnConfigSet, ConfigSet); }
        ...
        public float GetHeight(float x, float z)
        {
            ...
            float NoiseHeight() => Config?.GetHeight(x, CurPos.Y, z) ?? 0;
        }
        ...
        public override void _Process(double delta)
        {
            ...
            void UpdateView()
            {
                if (Camera is null)
                {
                    SetCurrentPosition(GlobalPosition);
                    return;
                }
